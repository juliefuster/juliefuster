...
export default function ParkingChiPage() {
  ...
  useEffect(() => {
    const saved = localStorage.getItem("parking_chi")
    if (saved) {
  ...
  const saveToLocalStorage = (data: ParkingRecord[]) => {
    localStorage.setItem("parking_chi", JSON.stringify(data))
  }
      ...
      <div className="max-w-7xl mx-auto space-y-6">
        <div className="flex items-center justify-between">
          <div>
            ...
            <h1 className="text-3xl md:text-4xl font-bold text-yellow-900">Dashboard Parking - Hotel Chi</h1>
              ...
              <CardContent className="p-4">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-2xl font-bold text-yellow-900 mt-1">{totalRecords}</p>
                  </div>
              ...
              <CardContent>
                <div className="overflow-x-auto">
                  <table className="w-full border-collapse">
                    <thead>
                      <tr className="bg-yellow-100 border-b-2 border-yellow-200">
