  ...
  useEffect(() => {
    async function fetchHistory() {
      try {
        ...
        console.error("Error loading pump change history:", error)
      } finally {
        setLoading(false)
      }
    }
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100">
      ...
      <main className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        {loading ? (
          ...
          <Card className="p-6 bg-white shadow-sm border border-slate-200 print:shadow-none print:border">
            <Table>
              <TableHeader>
                <TableRow className="bg-slate-100">
                  <TableHead className="font-bold text-slate-700">Mes</TableHead>
              ...
              <TableBody>
                {records.map((r, i) => (
                  <TableRow key={i}>
                    ...
                    <TableCell>{r.numero_bomba}</TableCell>
