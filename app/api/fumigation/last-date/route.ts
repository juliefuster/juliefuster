...
export async function GET(request: Request) {
  try {
    ...
    console.error("Error fetching last fumigation date:", err.message)
    return NextResponse.json({ error: "Failed to fetch last fumigation date", details: err.message }, { status: 500 })
  }
}
